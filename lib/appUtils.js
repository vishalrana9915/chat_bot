...
var generateSaltAndHashForPassword = function (password,cb) {
    ...
    // encryptPassword['salt'] = bcrypt.genSalt(10);
    // encryptPassword['hash'] = bcrypt.hash(password, encryptPassword['salt']);
    // console.log("after gensalt"+ncryptPassword['hash'])

    // return encryptPassword['hash'];
}
