...
function acceptRejectFriendRequests(request){
     return usrService.acceptRejectFriendRequests(request)
        .then(result=> userMapper.acceptRejectFriendRequests(request.action,result));
}
