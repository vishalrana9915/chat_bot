	...
	module.registerDirective('smartRouterAnimationWrap', function ($rootScope, $timeout) {
		...
		return {
			...
			compile: function (element, attributes) {
				...
				//SSM 042615 :: Split string into an array of substrings, and returns the new array.
				//We will use  a regular expression, "/\s/", whitespace character to use for splitting the string.
				...
				function contentViewAnimStart() {
					...
					$(animateElementSelector).addClass('animated fast fadeOutDown');
				}
