 ...
 * Path: app/layout/directives/enums/price-levels.js
 */
define(['layout/module',
    ...
    module.registerDirective('priceLevels', function ($rootScope, DefaultApiService) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'app/layout/partials/enums/price-levels-dd.tpl.html',
            link: function (scope, elements, attributes) {
                ...
                var populateEnums = function (enums) {
                    ...
                    scope.priceLevels = [];//Only change this scope variable to populate dropdown menu.
                    scope.enumOrders = {};
                    var enumIndex = 0;
                    scope.orderStatus = '';
                 ...
                 **/
                var enumsForArchive = [];
                DefaultApiService.getAllListCall(apiCallType + 'Mis.Interfaces.Enums.PriceLevels')
