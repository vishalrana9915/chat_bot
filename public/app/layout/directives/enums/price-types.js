 ...
 * Path: app/layout/directives/enums/price-types.js
 */
define(['layout/module',
    ...
    module.registerDirective('priceTypes', function ($rootScope, DefaultApiService) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'app/layout/partials/enums/price-types-dd.tpl.html',
            link:function(scope, elements, attributes ){
                ...
                var populateEnums = function(enums){
                    ...
                    scope.priceTypes = [];//Only change this scope variable to populate dropdown menu.
                    scope.enumOrders = {};
                    var enumIndex = 0;
                    scope.orderStatus = '';
                 ...
                 **/
                var enumsForArchive = [];
                DefaultApiService.getAllListCall(apiCallType + 'Mis.Interfaces.Enums.PriceTypes')
