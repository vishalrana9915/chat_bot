 ...
 * Path: app/layout/directives/enums/material-cost-types.js
 */
define(['layout/module',
    ...
    module.registerDirective('materialCostTypes', function ($rootScope, DefaultApiService) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'app/layout/partials/enums/material-cost-types-dd.tpl.html',
            link:function(scope, elements, attributes ){
                ...
                var populateEnums = function(enums){
                    ...
                    scope.materialCostTypes = [];//Only change this scope variable to populate dropdown menu.
                    scope.enumOrders = {};
                    var enumIndex = 0;
                    scope.orderStatus = '';
                 ...
                 **/
                var enumsForArchive = [];
                DefaultApiService.getAllListCall(apiCallType + 'Mis.Interfaces.Enums.MaterialCostTypes')
