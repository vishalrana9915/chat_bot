 ...
 * Path: app/layout/directives/enums/operations-ahm-types.js
 */
define(['layout/module',
    ...
    module.registerDirective('operationAhmTypes', function ($rootScope, DefaultApiService) {
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: 'app/layout/partials/enums/operations-ahm-types-dd.tpl.html',
            link:function(scope, elements, attributes ){
                ...
                var populateEnums = function(enums){
                    ...
                    scope.operationsAHMTypes = [];//Only change this scope variable to populate dropdown menu.
                    scope.enumOrders = {};
                    var enumIndex = 0;
                    scope.orderStatus = '';
                 ...
                 **/
                var enumsForArchive = [];
                DefaultApiService.getAllListCall(apiCallType + 'Mis.Interfaces.Enums.OperationAskHowManyTypes')
