define(['layout/module', 'jquery'], function (module) {
    ...
    module.registerDirective('smartMenu', function ($state, $rootScope, facilityRouteService) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
                ...
                element.on('click', 'a[data-ui-sref]', function (e) {
                    ...
                    scope.getJobListRoute = function(){
                        return facilityRouteService.getCurrentFacilityType();
                    };
