 ...
 * Path: public/app/layout/filters/decryptMessage.js
 */
...
define(['app'], function (module) {
	...
	module.registerFilter('decryptFilter', function() {
...
decode:function(e){
	...
	_utf8_decode:function(e){
		...
		return function(collection, keyname) {
			...
			var output = [],
				keys = [];
				// console.log(Base64.decode(collection))
				output =  Base64.decode(collection);
			return output;
		};
	});
});